...
class Gold_Price_Api extends WP_REST_Controller {
 /**
    ...
    function __construct() {
        $this->namespace = 'price/v1';
        $this->rest_base = 'goldprices';
    }
    ...
    /**
     * Retrieves a list of price items.
     *
     * @param  \WP_Rest_Request $request
     *
    ...
    public function get_item_schema() {
        ...
        $schema = [
            ...
            'properties' => [
                ...
                'name' => [
                    'description' => __( 'Name of the goldprice.' ),
                    'type'        => 'string',
                    'context'     => [ 'view', 'edit' ],
                    'required'    => true,
                    'arg_options' => [
                ...
                'price' => [
                    'description' => __( 'Price number of the goldprice.' ),
                    'type'        => 'string',
                    'required'    => true,
                    'context'     => [ 'view', 'edit' ],
                    'arg_options' => [
